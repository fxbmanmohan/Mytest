...
?></h3>
	<h3 style="color:#000; margin-left:10px;"> <h1>FXytes</h1>
	Subject : <?php echo $dn1['title']; ?>
	</h2>
	<div class="ReadMail" style="color:#333333;">
	     <?php echo "<p style='color:#000;'><b>Ref. #: </b>".$refrenceNo." ".$dn1['user_message_id']."</p>"; ?>
		<div class="ReadMailProperties"> <strong><?php echo $fromuser['user_fullname']; ?></strong> <?php echo isset($dn1['message_type'])?$dn1['message_type']:'';?> to <?php 
			...
			<ul>
				<li>
					...
					<?php if($_GET['type'] == 'draft'){
							echo "<a href='?sect=compose&msgid=".$dn1['message_id']."'>Compose Again</a>";
					}?>
