...
function sub_subLocate2(obj) {
    AjaxShow("POST", "ajaxFunctions.php?type=sub_subLocation2 && proID=" + obj, "Sub_ShowSubLocation2");
}

function sub_subLocate3(obj) {
    AjaxShow("POST", "ajaxFunctions.php?type=sub_subLocation3 && proID=" + obj, "Sub_ShowSubLocation3");
}
...
function changeScreen(screenID){
	switch (screenID){
		...
		<?php if($_SESSION['web_report_quality_assuarance'] == 1){?>
				...
				document.getElementById('buttoon_qatask').setAttribute("class", "buttoon_qatask");
		<?php }?>
		...
		<?php } ?>
				...
				document.getElementById('button_qualityControl').setAttribute("class", "button_qualityControlActive");
		break;

		case "buttoon_qatask": 
		<?php if($_SESSION['web_report_quality_assuarance'] == 1){?>
				document.getElementById('buttoon_QATaskScreen').style.display = 'block';
				document.getElementById('buttoon_qatask').setAttribute("class", "buttoon_qataskActive");
		<?php }?>
		<?php if($_SESSION['web_report_progress_monitoring'] == 1){?>
				document.getElementById('buttoon_progressMonitoringScreen').style.display = 'none';
				document.getElementById('buttoon_progressMonitoring').setAttribute("class", "buttoon_progressMonitoring");
		...
		<?php if($_SESSION['web_report_checklist'] == 1){?>
				...
				document.getElementById('buttoon_checklist').setAttribute("class", "buttoon_checklistActive");
		<?php } ?>
		<?php if($_SESSION['ww_is_company'] == 1){?>
				document.getElementById('buttoon_CompScreen').style.display = 'none';
				document.getElementById('button_companySummary').setAttribute("class", "button_companySummary");
		...
		<?php } ?>
				...
				document.getElementById('button_companySummary').setAttribute("class", "button_companySummaryActive");
		break;
...
<? }?>
<?php if($_SESSION['ww_is_company'] == 1){?>
//	document.getElementById('projectErrorComp').style.display = 'none';
<? }?>
}
...
function pageScroll(limit){
	...
	for(var x=0; x<document.getElementById('issuedTo').length; x++){
		...
		if(reportType == 'pdfDetail'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_pdf_detail.php?'+params, loadingImage);
		}else if(reportType == 'pdfDetailHD'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_pdf_detail_hd.php?'+params, loadingImage);
		}else if(reportType == 'pdfSummayWithOutImages' || reportType == 'pdfSummayWithImages'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_pdf_summary.php?'+params, loadingImage);
		}else if(reportType == 'csvReport'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_csv.php?'+params, loadingImage);
		}
	}catch(e){
		//alert(e.message); 
	}
...
//Set Data for remebarains start here
	$.post("ajaxFunctions.php?session_type=ir&"+params);
		/*if (window.XMLHttpRequest){xmlhttp=new XMLHttpRequest();}else{xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");}
...
//Set Data for remebarains end here
		...
		if(reportType == 'pdfDetail'){
			...
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_pdf_summary_notes.php?'+params, loadingImage);
		}else if(reportType == 'pdfSummayWithoutNotes'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_pdf_summary.php?'+params, loadingImage);
		}else if(reportType == 'summaryCostImpact'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_pdf_summary_cost_impact.php?'+params, loadingImage);
		}else if(reportType == 'executiveReport'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_executive_report.php?'+params, loadingImage);
		}else if(reportType == 'issuedtoExecutiveReport'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_issuedto_executive_report.php?'+params, loadingImage);
		}else if(reportType == 'subContractorReport'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_pdf_summary_sub_contractor.php?'+params, loadingImage);
		}else if(reportType == 'healthCheckReport'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'pdf/i_report_pdf_health_check_report.php?'+params, loadingImage);
		}else if(reportType == 'csvReport'){
			if (window.XMLHttpRequest){xmlhttp=new XMLHttpRequest();}else{xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");}
			showProgress();
...
if(dateChackFixed === false){	return false;	}
		...
		if(reportTypePM == 'inCompleteWork'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_pdf_in_complete_works.php?'+params, loadingImage);
		}else if(reportTypePM == 'doorSheet'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_pdf_door_sheet.php?'+params, loadingImage);
		}
	}catch(e){
		//alert(e.message);
	}
...
//Set Data for remebarains start here
		$.post("ajaxFunctions.php?session_type=pmr&"+params);
		/*
		if (window.XMLHttpRequest){xmlhttp=new XMLHttpRequest();}else{xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");}
...
//Set Data for remebarains end here
		...
		if(reportTypePM == 'inCompleteWork'){
			...
			params = params+"&uniqueId="+Math.random();
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'wallChart.php?'+params, loadingImage);
		}else if(reportTypePM == 'wallCharta3'){
			params = params+"&uniqueId="+Math.random();
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'wallChart_a3.php?'+params, loadingImage);
		}else if(reportTypePM == 'wallCharta3summary'){
			params = params+"&uniqueId="+Math.random();
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'pdf/i_report_wall_chart_a3_summary.php?'+params, loadingImage);
		}else if(reportTypePM == 'wallCharta3client'){
			params = params+"&uniqueId="+Math.random();
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'pdf/i_report_wall_chart_a3_client.php?'+params, loadingImage);
		}
	}catch(e){
		//alert(e.message);
	}
...
//Set Data for remebarains start here
		$.post("ajaxFunctions.php?session_type=qar&"+params);
		/*
		if (window.XMLHttpRequest){xmlhttp=new XMLHttpRequest();}else{xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");}
...
//Set Data for remebarains end here
		...
		if(reportTypeQA == 'qaReport'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_qa.php?'+params, loadingImage);
		}else if(reportTypeQA == 'nonConformance'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_non_conformance.php?'+params, loadingImage);
		}else if(reportTypeQA == 'nonConformanceDetail'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'pdf/i_report_non_conformance_detailed.php?'+params, loadingImage);
		}else if(reportTypeQA == 'statusReport'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_qa_status.php?'+params, loadingImage);
		}else if(reportTypeQA == 'wallchartReport'){
			modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_qa_wallchart.php?'+params, loadingImage);
		}
	}catch(e){
		//alert(e.message); 
	}
...
//Set Data for remebarains start here
		$.post("ajaxFunctions.php?session_type=clr&"+params);
		/*
		if (window.XMLHttpRequest){xmlhttp=new XMLHttpRequest();}else{xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");}
...
//Set Data for remebarains end here
		...
		modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'i_report_checklist.php?'+params, loadingImage);
	}catch(e){
		//alert(e.message); 
	}
}
function submitFormComp(){
	try{
		...
		modalPopup(align, top1, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'pdf/company_project_summary.php?'+params, loadingImage);
...
$('#subLocationQA1').live("change", function(){
	...
	<div id="containerTop" style="width:100%; margin:auto;">
		<div class="content_hd1" style="width:250px;float:left;"></div>
	<?php if($_SESSION['ww_is_company'] == 1){?>
				...
				<td colspan="2" valign="top">
					<select name="projName" id="projName"  class="select_box" onChange="resetIds();startAjax(this.value);" style="width:220px;background-image:url(images/selectSpl.png);background:#0987c8 url(images/selectSpl.png) no-repeat\9;">
						...
						<?php if(isset($_SESSION['ww_is_company'])){
							FillSelectBox("project_id, project_name","user_projects","is_deleted=0","project_name", 'qc_section');
						}else{
...
<?php }?>
            ...
            <tr>
				...
				<td align="left" valign="middle" nowrap="nowrap" style="color:#FFFFFF;">Search Keyword</td>
				<td colspan="2">
...
background-image: url(images/selectSpl.png);margin-left:0px;margin-left:28px;padding: 0 20px 0 20px;" 
			...
			<tr>
				...
				<td colspan="2" id="Sub_ShowSubLocation2">
					<select name="sub_subLocation2" id="sub_subLocation2"  class="select_box" style="width:220px;background-image:url(images/selectSpl.png);">
                                                                                                 <option value="">Select</option>
					</select>
				</td>
				<td align="left" valign="middle" nowrap="nowrap" style="color:#FFFFFF;">Sub Location 3</td>
				<td colspan="2" id="Sub_ShowSubLocation3">
					<select name="sub_subLocation3" id="sub_subLocation3" class="select_box" style="width:220px;background-image:url(images/selectSpl.png);">
						<option value="">Select</option>
					</select>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="2" valign="top">
					<select name="projName" id="projNamePM" class="select_box" onChange="resetIds();startAjax1(this.value);" style="width:220px;background-image:url(images/selectSpl.png);">
						<option value="">Select</option>
						<?php if(isset($_SESSION['ww_is_company'])){
							FillSelectBox("project_id, project_name","user_projects","is_deleted=0","project_name", 'pm_section');
						}else{
			...
			<tr>
				...
				<td colspan="2" valign="top">
					<select name="projName" id="projNameQA" class="select_box" onChange="resetIds();startAjaxQA(this.value);" style="width:220px;background-image:url(images/selectSpl.png);">
						<option value="">Select</option>
						<?php if(isset($_SESSION['ww_is_company'])){
							FillSelectBox("project_id, project_name","user_projects","is_deleted=0","project_name", 'qa_section');
						}else{
			...
			<tr>
				...
				<td colspan="2" valign="top">
					<select name="projName" id="projNameCL"  class="select_box" onChange="resetIds();startAjaxCL(this.value);" style="width:220px;background-image:url(images/selectSpl.png);background:#0987c8 url(images/selectSpl.png) no-repeat\9;">
						<option value="">Select</option>
						<?php if(isset($_SESSION['ww_is_company'])){
							FillSelectBox("project_id, project_name","user_projects","is_deleted=0","project_name", 'cl_section');
						}else{
