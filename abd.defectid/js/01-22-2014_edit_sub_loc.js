$(document).ready(function() {
	...
	messages:
	{
		...
		userName:
		{
			...
			minlength:'<div class="error-edit-profile">The username field be greater than 3 characters</div>'
			
		},
		password:
		{
			required: '<div class="error-edit-profile">The password field is required</div>',
			minlength:'<div class="error-edit-profile">The password must be minimum 6 character</div>'
