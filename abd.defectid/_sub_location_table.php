...
<div id="container">
	...
	<?php 
		$pid=base64_encode($_SESSION['idp']);
		$hb=base64_encode($_SESSION['hb']);
	
	if($_SESSION['ww_is_builder']==1){?>
	<div class="content_hd1" style="background-image:url(images/inspectors.png);">
   <a href="?sect=add_project_detail&id=<?php echo $pid;?>&hb=<?php echo $hb;?>">
                    <img src="images/back_btn.png" style="border:none; width:111px;margin-left:855px;" /></a>
	...
	if($id!=''){
		...
		$q =  "SELECT *, p.project_id as project_id FROM ".OWNERS." o 
			  LEFT JOIN ".PROJECTS." p ON p.project_id = o.ow_project_id 
