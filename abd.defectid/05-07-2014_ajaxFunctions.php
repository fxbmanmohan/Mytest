...
function SearchInpection($proID, $type, $isReqReport){
	switch($type){
		...
		$name='name="location" id ="location" onChange="subLocate(this.value);"'; SelectListWithID($q, $name, 'location', $isReqReport);
		break;
		...
		$name='name="sub_subLocation" id ="sub_subLocation"'; SelectListWithID($q, $name, 'sub_subLocation', $isReqReport);
		break;
		...
		$name='name="subSubLocation" id="subSubLocation"'; SelectListWithID($q, $name, 'subSubLocation', $isReqReport);
		break;
