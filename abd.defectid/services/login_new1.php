...
mysql_query("insert into exportData set sync_url='". $sync_url."'");
//$db->updateExportTable_updated('/download/' . 'login', $_REQUEST['userId'], 'ipad', 'login', $sync_url);
