...
//Data collection part start here
	...
	$historyData = selQRYMultiple('export_files_id, path, userid, exportDataType', 'exportData', 'created_date <= "2014-06-01 00:00:00"');
	...
	$historyData = selQRYMultiple('import_files_id, path, userid, importDataType', 'importData', 'created_date <= "2014-06-01 00:00:00"');
