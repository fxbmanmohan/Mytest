...
ul.telefilms{list-style:none; cursor:pointer;}
ul.telefilms li ul{list-style:none;}
...
<div id="rightCont" style="float:left;width:700px;">
	<div class="content_hd1" style="background-image:url(images/location_header.png);width:500px;margin-top:20px;">
		<a href="?sect=add_project_detail&id=<?php echo $id;?>&hb=<?php echo $hb;?>"><img src="images/back_btn.png" style="border:none; width:111px;margin-left:530px;" /></a>
	</div>
	...
	<div style="width:722px; height:50px; float:left; margin-top:5px;">
        <form method="post" name="csvLocation" id="csvLocation" enctype="multipart/form-data">
			<table width="650px" border="0" cellspacing="0" cellpadding="3">
				<tr>
					<td colspan="2" align="left"><font size="+1"><a href="/csv/location3_new.csv" style="text-decoration:none;color:#FFF;">Click here to download CSV template</a></font></td>
				</tr>   
				...
				<?php } ?>
				<tr>
					<td width="25%" height="10px">Upload CSV File :</td>
					<td width="50%" align="left"><input type="file" name="csvFile" id="scvFile" value="" /></td>
...
<span class="jtree-button demo2" id="projectId_<?php echo $_SESSION['idp']?>" style="background-image: url('images/project.png');background-position: 0 0;background-repeat: no-repeat;display: block;height: 20px;padding-left: 40px;padding-top: 9px;width: 100px;"><?php echo $obj->getDataByKey('user_projects', 'project_id', $_SESSION['idp'], 'project_name')?></span>
