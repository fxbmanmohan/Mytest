...
if(isset($_POST['button_x']))
{
	...
	else
	{
		...
		{
			$issue_update="update inspection_issue_to set issue_to_name='".$issue_contact_name."',company_name='".$issue_company_name."',issue_to_phone='".$issue_phone."',issue_to_email='".$issue_emailid."',last_modified_date=now(),last_modified_by=".$builder_id." where issue_to_id='".base64_decode($_REQUEST['id'])."'";
		...
		<form  method="post"  enctype="multipart/form-data" name="addissueto" id="addissueto" >
			...
			<div class="content_container">
				<div class="content_left">
					<div class="content_hd1" style="background-image:url(images/hd_edit_issue.png);"></div>
						...
						<table width="470" border="0" align="left" cellpadding="0" cellspacing="15" style="margin-top:-60px;">
							...
							<tr>
								...
								<td>
                                	...
                                	<input name="contact_name"  value="<?php echo $row['issue_to_name'] ;?>" type="text" class="input_small" id="contact_name" />
                                </td>
							</tr>
                            <tr>
								<td valign="top">Company Name <span class="req">*</span></td>
								<td><input name="company_name"  value="<?php echo $row['company_name'] ;?>"  type="text" class="input_small" id="company_name" /></td>
							</tr>
							<tr>
