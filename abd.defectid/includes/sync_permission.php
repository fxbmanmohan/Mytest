...
table.gridtable td { border-width: 1px; padding: 8px; border-style: solid; border-color: #FFF; font-size:14px; }
		...
		<div id="rightCont" style="float:left;width:700px;">
			<div class="content_hd1" style="width:500px;margin-top:12px;">
				...
				<a href="?sect=add_project_detail&id=<?=$id;?>&hb=<?=$hb;?>" style="float:left;margin-top:-25px; width:87px;margin-left:586px;z-index:100;">
					<img src="images/back_btn2.png" style="display:block; border:none;z-index:999999999999;" />
				</a>
			</div><br clear="all" />
		...
		foreach($syncPermissionData as $syncPermission){ $g++;?>
			<fieldset class="permission">
				...
				<table border="0" width="100%" cellspacing="0"  cellpadding="2">
					<tr>
						<td align="center" style="color:#FFFFFF;">No of Days</td>
						<td align="center" style="color:#FFFFFF;">Status of Inspections</td>
					</tr>
					<tr>
...
<div id="selet_value_<?=$g;?>" style="color:#FFFFFF; text-align:left;"><?=str_replace("'", '', $syncPermission['status']);?></div>
						</td>
					</tr>
				</table>
				...
				<input type="button" class="submit_btn" name="Submit" style="background-image:url(images/save_min.png); font-size:0px; border:none; width:111px;margin:5px 0 0 588px;height:29px;" onclick="<?=$syncPermission['device_type'];?>FormSubmit();">
...
<?php  } 
			...
			<fieldset class="permission">
				...
				<input type="checkbox" name="selectAllCheckBox" id="selectAllCheckBox" value="selectAll" onclick="toggleCheckAll(this, 'locationsContainer');"  <?php if($check){ echo 'checked="checked"'; }?>  />&nbsp;<span style="font-size:15px;">Select All Locations</span>
					<input type="button" class="submit_btn" name="Submit" style="background-image:url(images/save_min.png); font-size:0px; border:none; width:91px;margin:-24px 0 0 558px;height:29px;" onclick="selectedLocationSubmit(this, 'locationContenter');" />
					...
					<input type="button" class="submit_btn" name="Submit" style="background-image:url(images/save_min.png); font-size:0px; border:none; width:91px;margin:5px 0 0 558px;height:29px;" onclick="selectedLocationSubmit(this, 'locationContenter');"  />
				</div>
