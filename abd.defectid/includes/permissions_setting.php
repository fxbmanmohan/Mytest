...
.has-js .label_check input{ position: absolute; left: -999px; border:1px solid red;}
/*
label.spCheckbox { background: url(images/bullet.gif) no-repeat 0 0; float: left; font-family:Tahoma, Geneva, sans-serif; font-size:13px; text-align:left; padding-left: 25px; margin-right:5px; border:1px solid red; width:290px;}
input[type=checkbox] + label.spCheckbox { display:block;  margin-top:10px; margin-left:8px; height: 18px; position:relative; }
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr>
								<td colspan="3" align="left" style="padding-bottom:15px;">
									<strong style="font-size:16px;color:#ffffff;">&nbsp;&nbsp;Assign Permission to User</strong>
								</td>
							</tr>
							<tr>
...
<?php if(!empty($newUsers)){
	...
	<?php }
								...
								<td width="20%">
									<input name="button" type="submit" class="submit_btn" id="button" value="" style="background-image:url(images/submit_btn.png); border:none; width:111px; margin-right:-37px;" />
...
<?php if(!empty($usersData)){?>
	...
	<form action="" name="permissionUser" id="permissionUser" method="post">
		...
		<input type="submit" class="submit_btn" name="Submit" style="background-image:url(images/save.png); font-size:0px; border:none; width:111px;margin:15px 0 15px 545px;"  />
	</form>
	</div>
<?php }?>
