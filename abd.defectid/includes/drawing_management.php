						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-left:15px;" >
							...
							<tr>
								<td colspan="2" align="right" height="50px">
									<input type="submit" style="cursor:pointer; background: url('images/submit_btn.png') repeat scroll 0 0 transparent;border: medium none;height: 30px;margin-right:35px;width: 87px;color:transparent; font-size:0px;"  name="save" id="save" />
								</td>
							</tr>
						</table>
					</form>
