...
function prevQC(obj1)
{
	...
	if(obj1==true)
	{
		document.getElementById("chart3_if").src = "/full_analysis_expand.php?count=" + it_end;
	}
	else
	{
		document.getElementById("chart2_if").src = "/full_analysis.php?count=" + pm_end;
	}
...
function prevPM(obj1)
{
	...
	if(obj1==true)
	{
		document.getElementById("chart3_if").src = "/progress_chart_expand.php?count=" + it_end;
	}
	else
	{
...
function expandIframe (div_id, iframe_id){
	...
	if (div_id=="full_analysis")
	{
		...
		document.getElementById("chart1").src = "/full_analysis_expand.php?count=0"
	...
	else if (div_id=="progress_monitor_summary")
	{
		...
		document.getElementById("issue_to_summary").style.display = "none";
		document.getElementById("notification_board").style.display = "none";
		document.getElementById("chart2_if").src = "/progress_chart_expand.php?count=0"
	...
	else if (div_id=="issue_to_summary")
	{
		...
		document.getElementById("progress_monitor_summary").style.display = "none";
		document.getElementById("notification_board").style.display = "none";
		document.getElementById("chart3_if").src = "/issue_to_chart_expand.php?count=0";
	...
	else if (div_id=="notification_board")
	{
		...
		//document.getElementById("exp_pm3").src = "/notification_board_expand.php?count=0";
	}
	else
	{
...
<div class="first_box" style="margin-left:5px;" id="notification_board">  
		<h1><img src="images/notification_board.png" width="43" height="40" align="absmiddle" /> Notification Board</h1>
         <h1 style="margin-left:240px;font-size:14px;margin-top:20px;"><a href="#" onclick="expandIframe('notification_board','chart3_if')" style="text-decoration:none;" id="exp_pm3"><img src="images/maximize.png" alt="Click to expand" title="Click to expand" /></a>
        </h1>
        <h1>
        <a href="?sect=b_full_analysis"  style="text-decoration:none;display:none;margin-left:720px;margin-top:-20px;" id="close_pm3" ><img src="images/close_new.png" alt="Click to close" title="Click to close" /></a>
        </h1>
		 <table width="80%" border="0" cellspacing="0" cellpadding="2" style="margin-top:0px;margin-left:20px" class="gridtable">
             ...
             <tr>
                ...
                <td rowspan="5" align="center" valign="middle"><h1 style="color:#000;">Average Time to close Inspections(days)<br/><br/><?php if($overdue_closed_rows_total!=0)
				echo $avg= round($overdue_closed_total/$overdue_closed_rows_total);?></h1></td>
             </tr>
             <tr>
                <td>Due in 1 day</td>
