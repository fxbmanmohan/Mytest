...
<div class="search_multiple">
	<div class="first_box" id="full_analysis"> <!--Start Code For Full Analysis Box-->
        ...
        <h1 style="margin-left:205px;font-size:14px;margin-top:20px;"><a href="#" onclick="expandIframe('full_analysis','chart1')" style="text-decoration:none;" id="exp_pm"><img src="images/maximize.png" alt="Click to expand" title="Click to expand" border="0" /></a>
...
<div class="first_box" style="margin-left:5px;" id="notification_board">  
		...
		<?php $st = 'style="margin:-27px 25px 0 227px;font-size:14px;float:right;"'; 
         ...
         <h1 <?=$st;?> ><a href="#" onclick="expandIframe('notification_board','chart4_nb')" style="text-decoration:none;" id="exp_pm3"><img src="images/maximize.png" alt="Click to expand" title="Click to expand"  border="0" /></a>
        <a href="#" onclick="closeIframe('notification_board','chart4_nb')"  style="text-decoration:none;display:none;margin-left:720px;margin-top:-20px;<?php if(!isset($_SESSION['ww_is_company'])){echo 'margin-top:0px;';}?>" id="close_pm3" ><img src="images/close_new.png" alt="Click to close" title="Click to close" /></a>
        </h1>
		 <table width="100%"  border="0" cellspacing="0" cellpadding="2" style="margin-top:0px;" class="gridtable">
         	 
             <tr>
                <td> <iframe src="about:blank" id="chart4_nb" style="width:455px; height:270px;height:240px\9;margin:0px;margin-top:-10px;padding:0px;border:0px;" frameBorder="0"></iframe></td>
          	</tr>
          </table>
</div>
</div>
