			...
			<div style="width:722px; height:70px; float:left; margin-top:5px;">
				...
				<table width="690px" border="0" cellspacing="0" cellpadding="3">
					...
					<tr>
						...
						<td width="120px;" height="50px"><input style="background: url('images/import_csv_btn.png') repeat scroll 0 0 transparent;border: medium none;height: 30px;margin-left: 0;width: 87px;color:transparent;font-size:0px;"   type="button" name="location_csv" id="location_csv" value="Import CSV" onclick="validateSubmit();"  /></td>
					</tr>
				</table>
				</form>
			</div>
