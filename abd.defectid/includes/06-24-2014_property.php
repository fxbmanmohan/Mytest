...
define('DEF_HOST', 'wwproddb.ctw4zioqzjbf.ap-southeast-2.rds.amazonaws.com');
define('DEF_USER', 'wisebytewwfx');
define('DEF_PASSWORD', 'DB*uiokLOP98');
define('DEF_DBNAME', 'defectid_abdgroup');
