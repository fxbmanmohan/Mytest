...
<?php if(isset($_SESSION['ww_is_company'])){?>
	<a href="?sect=c_defect&bk=Y"><img src="images/back_btn.png" style="border:none; width:111px;" /></a>
<?php }else{?>
	<a href="?sect=i_defect&bk=Y"><img src="images/back_btn.png" style="border:none; width:111px;" /></a>
<?php }?>
							</td>
							<td align="center">
<?php if($_SESSION['web_edit_inspection'] == 1 || $_SESSION['userRole'] == 'Sub Contractor'){?>
								<a href="?sect=edit_defect&did=<?php echo base64_encode($f['inspection_id']);?>"><img src="images/edit_btn.png" style="border:none; width:111px;" /></a>
<?php }?>
							</td>
						</tr>
					</table></div>
