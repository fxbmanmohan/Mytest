...
if(isset($_GET['mode'])){
	...
	$userData = $object->selQRY('u.user_name, u.user_fullname, u.user_password, u.user_plainpassword, u.user_phone_no, u.user_email, up.user_role, up.issued_to', 'user as u, user_projects as up', 'up.project_id = "'.$_SESSION['idp'].'" AND u.user_id = "'.$userId.'" and u.is_deleted = 0 and up.is_deleted = 0 and u.user_id = up.user_id');
		...
		<div class="signin_form" style="margin-top:0px;margin-top:-20px\9;">
			<table width="470" border="0" align="left" cellpadding="0" cellspacing="15">
				...
				<tr>
					...
					<td width="312" colspan="2">
						<input type="text" class="input_small" readonly style="background-image:big_input_big_readonly.png;" value="<?=stripslashes($f['project_name'])?>" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="312" colspan="2">
						<input name="userName" type="text" class="input_small" <?php if(isset($_GET['mode'])){?> readonly<?php }?>   id="userName" value="<?php echo isset($_SESSION['post_array']['userName'])?$_SESSION['post_array']['userName']:$userName;?>" /> 
				...
				<tr>
					<td width="134" nowrap="nowrap" valign="top">Password <span class="req">*
						</span><div style="color:#FFF;font-size:9px;">(Minimum 6 characters)</div></td>
					<td width="312" colspan="2">
...
<?php }?>
				...
				unset($_SESSION['post_array']); ?>
					<td align="left">
						<a href="javascript:void();" onclick="history.back();"><input name="passwordUpdate" type="button" class="submit_btn" id="button" value="" style="background-image:url(images/back_btn.png); width:111px; border:none;padding-bottom:10px;"></a>
					</td>
				</tr>
			</table>
		</div>
