		...
		<form action="ajax_reply.php" method="post"  enctype="multipart/form-data" name="editproject" id="editproject" >
			...
			<div class="content_container">
				<div class="content_left">
					<div class="content_hd1" style="background-image:url(images/add_projectt_hd.png);margin-top:-50px\9;"></div>
					...
					<div class="signin_form">
						<table width="550" border="0" align="left" cellpadding="0" cellspacing="15">
							...
							<tr>
								<td width="183" valign="top">Address Line 2</td>
								<td width="242"><input name="line2" type="text" class="input_small" id="line2" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input name="certificate_of_occupancy" id="certificate_of_occupancy" class="input_small" readonly="readonly" /></td>
							</tr>  
							<tr>
								<td valign="top">Open date</td>
								<td><input name="open_date" id="open_date" class="input_small" readonly="readonly" /></td>
							</tr>  
							<tr>
								<td valign="top">Proposed completion</td>
								<td><input name="proposed_completion" id="proposed_completion" class="input_small" readonly="readonly" /></td>
							</tr>  
							<tr>
								<td valign="top">Actual completion</td>
								<td><input name="actual_completion" id="actual_completion" class="input_small" readonly="readonly" /></td>
							</tr>                                                                                                                
							<tr>
								<td>&nbsp;</td>
								<td>
