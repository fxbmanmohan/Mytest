					...
					if(!empty($fieldarray[$i][0]))
					{
						...
						else
						{
							...
							@$insert="INSERT INTO inspection_issue_to SET
											company_name = '".$fieldarray[$i][1]."',
											issue_to_name = '".$fieldarray[$i][0]."',
...
<table width="100%" border="0" align="left" cellpadding="5" cellspacing="0">
  ...
  <div class="content_hd1" style="background-image:url(images/issued_header.png);width:500px;margin-top:10px;margin-left:260px;"></div>
...
<div style="width:722px; height:50px; float:left; margin-top:5px;">
        ...
        <form method="post" name="csvIssueto" id="csvIssueto" enctype="multipart/form-data">
                        <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                 ...
                                 <tr>
                                	<td colspan="2" align="center" style="padding-left:220px;"><font size="+1"><a href="/csv/issueto.csv" style="text-decoration:none;color:#FFF;">Click here to download CSV template</a></font></td>
                                 </tr>   
                                ...
                                <tr>
                                        ...
                                        <td width="70%" align="left"><input type="file" name="csvFile" id="csvFile" value="" /></td>
								</tr>
                                <tr>
