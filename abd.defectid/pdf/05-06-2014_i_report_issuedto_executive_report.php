...
//Title String Header
	...
	foreach($htmlDataArr as $htmlData){
		...
		if($pageCount == 1){
			...
			$pdf->Cell(90, $yH, $htmlData['issuedName'], 1, 0, 'L', false);
			$pdf->Cell(50, $yH, $htmlData['noOfInsp'], 1, 0, 'C', false);
			$pdf->Cell(20, $yH, $htmlData['open'], 1, 0, 'C', false);
			$pdf->Cell(20, $yH, $htmlData['closed'], 1, 0, 'C', false);
			$pdf->Cell(20, $yH, $htmlData['pending'], 1, 0, 'C', false);
	}		
