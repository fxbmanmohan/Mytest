...
/*	 	if(!empty($_POST['location']) && isset($_POST['location'])){
	...
	$html .='<table width="555" class="collapse" cellpadding="0" cellspaccing="0" align="center">
				...
				<tr>
					...
					$html .='</td>
					<td colspan="3" rowspan="3" valign="top" style="font-size:10px;">&nbsp;'.stripslashes(wordwrap($fi[9], 90, '<br />&nbsp;')).'</td>
				</tr>
				<tr>
...
$images = $obj->getRecords('inspection_graphics', 'inspection_id', $fi[11], 'graphic_type', 'images', 'graphic_name');
...
$drawing = $obj->getRecords('inspection_graphics', 'inspection_id', $fi[11], 'graphic_type', 'drawing', 'graphic_name');
