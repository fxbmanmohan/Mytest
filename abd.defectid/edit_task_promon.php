		...
		<fieldset class="roundCorner">
			...
			<table border="0" width="100%" class="simpleTable">
				...
				<tr>
					...
					<td align="left">
						<input type="text" name="startDate" id="startDate" value="<?=date('d/m/Y', strtotime($taskData[0]['startDate']))?>" readonly="readonly" />
						<div class="error-edit-profile-red" style="width:100px;display:none;"  id="taskError">Task require field</div>
					</td>
				</tr>
				<tr>
...
#print_r($_POST);die;
	...
	if(!in_array($_POST['task'], $taskCheckArr)){
		...
		$update_issue = "UPDATE issued_to_for_progress_monitoring SET is_deleted = 1, last_modified_date = NOW(), last_modified_by = ".$_SESSION['ww_builder_id']." WHERE progress_id = ".$_POST['progressID']."";
