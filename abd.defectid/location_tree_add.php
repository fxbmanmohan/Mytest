...
if(isset($_POST['uniqueId'])){
	...
	$query = 'UPDATE project_locations SET location_id_tree = "'.$locIdTree.'", location_name_tree = "'.$locNameTree.'" WHERE location_id = '.$insertedId;
	mysql_query($query);
		...
		if(mysql_num_rows($res) > 0){
			...
			<fieldset class="roundCorner">
				...
				<table width="100%" border="0">
					...
					<tr>
						<td align="center" colspan="2" style="padding-top:20px;"><input type="submit" name="submit" id="submit" value="Submit" onclick="addLocation()"  /></td>
					</tr>
				</table>
			</fieldset>
