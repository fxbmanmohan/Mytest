...
?>
<script type="text/javascript"> var dropDownSelect;// = 10;
</script>
<?php
$projectName = '';
$locationName = '';
...
if (isset($_GET['pid']) && $_GET['pid'] != "")
    $_SESSION['qc']['projName'] = $_GET['pid'];
if (isset($_GET['locid']) && $_GET['locid'] != "")
    $_SESSION['qc']['location'] = $_GET['locid'];
if (isset($_GET['sts']) && $_GET['sts'] != "")
    $_SESSION['qc']['status'] = $_GET['sts'];
if (isset($_GET['isst']) && $_GET['isst'] != "")
    $_SESSION['qc']['issuedTo'] = $_GET['isst'];
if (isset($_GET['spParam']) && $_GET['spParam'] != "")
    $_SESSION['qc']['spParam'] = $_GET['spParam'];

if (isset($_GET['FBDF']) && $_GET['FBDF'] != "")
    $_SESSION['qc']['FBDF'] = $_GET['FBDF'];
if (isset($_GET['FBDT']) && $_GET['FBDT'] != "")
    $_SESSION['qc']['FBDT'] = $_GET['FBDT'];
...
<body id="dt_example">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function sub_subLocate2(obj) {
            AjaxShow("POST", "ajaxFunctions.php?type=sub_subLocation2 && proID=" + obj, "SubShowSubLocation2");
        }
        
        function sub_subLocate3(obj) {
            AjaxShow("POST", "ajaxFunctions.php?type=sub_subLocation3 && proID=" + obj, "SubShowSubLocation3");
        }
        ...
        function submitForm(bStateSaveFlag) {
            ...
            var params = "projName=" + projName + "&location=" + location + "&subLocation=" + subLocation + "&subSubLocation=" + subSubLocation + "&status=" + status + "&inspectedBy=" + inspectedBy + "&issuedTo=" + issuedTo + "&inspecrType=" + inspecrType + "&costAttribute=" + costAttribute + "&raisedBy=" + raisedBy + "&DRF=" + DRF + "&DRT=" + DRT + "&FBDF=" + FBDF + "&FBDT=" + FBDT;
<?php if ($_GET['from'] == "nb") { ?>
...
<?php } ?>
            ...
            oTable = $("#inspTable").dataTable({
                ...
                "aoColumnDefs": [{"bSearchable": false, "bSortable": false, "aTargets": [3, 4, 5, 6, 9]}],
    ...
    <div id="container" style="width:99%;margin-top:25px;min-height:510px;">
        ...
        $myInspections = '';
        ?>
        <div class="content_hd1" style="background-image:url(images/defects_hd.png);"></div><br clear="all" />
        <?php if (isset($_SESSION['inspection_added'])) { ?>
            ...
            <?php
            unset($_SESSION['inspection_added']);
        }
        ?>
        <?php if (base64_decode($_GET['ms']) == 'Deleted') { ?>
            <div id="errorHolder" style="margin-left: 10px;margin-top:15px;margin-bottom:15px;">
                <div class="success_r" style="height:35px;width:405px;"><p>Inspection Deleted Successfully !</p></div>
            </div>
        <?php } ?>
            ...
            <form action="" method="post" name="defectSearch" id="defectSearch">
                <table width="" cellpadding="0" cellspacing="5" border="0">
                    ...
                    <tr>
                        ...
                        <td colspan="2" align="right" id="SubShowSubLocation2"><select name="subSubLocation2" id="subSubLocation2"  class="select_box" style="width:220px;background-image:url(images/selectSpl.png);">
                                <option value="">Select</option>
                            </select></td>
                        <td align="left" valign="top" nowrap="nowrap" style="color:#FFFFFF;">Sub Location 3</td>
                        <td colspan="2" align="right" id="SubShowSubLocation3"><select name="subSubLocation3" id="subSubLocation3"  class="select_box" style="width:220px;background-image:url(images/selectSpl.png);">
                                <option value="">Select</option>
                            </select></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" align="right"><select name="status" id="status" class="select_box" style="width:220px;background-image:url(images/selectSpl.png);">
                                ...
                                if (isset($_SESSION['qc']['status'])) {
                                    if ($_SESSION['qc']['status'] == 'Open') {
                    ...
                    <tr>
                        ...
                        <td colspan="2" id="ShowPriority" align="right"><select name="inspecrType" id="inspecrType" class="select_box" style="width:220px;background-image:url(images/selectSpl.png);">
                                ...
                                if (isset($_SESSION['qc']['inspecrType'])) {
                                    if ($_SESSION['qc']['inspecrType'] == 'Issue') {
                                        echo 'selected="selected"';
                                    }
                                }
                                ?>>Issue</option>
                                <option value="Defect"<?php
                                if (isset($_SESSION['qc']['inspecrType'])) {
                                    if ($_SESSION['qc']['inspecrType'] == 'Defect') {
                                        echo 'selected="selected"';
                                    }
                                }
                                ?>>Defect</option>
                                <option value="Warranty"<?php
                                if (isset($_SESSION['qc']['inspecrType'])) {
                                    if ($_SESSION['qc']['inspecrType'] == 'Warranty') {
                                        echo 'selected="selected"';
                                    }
                                }
                                ?>>Warranty</option>
                                <option value="Incomplete Works" <?php
                                if (isset($_SESSION['qc']['inspecrType'])) {
                                    if ($_SESSION['qc']['inspecrType'] == 'Incomplete Works') {
                                        echo 'selected="selected"';
                                    }
                                }
                                ?>>Incomplete Works</option>
                                <option value="Purchase Changes"<?php
                                if (isset($_SESSION['qc']['inspecrType'])) {
                                    if ($_SESSION['qc']['inspecrType'] == 'Purchase Changes') {
                                        echo 'selected="selected"';
                                    }
                                }
                                ?>>Purchase Changes</option>
                    ...
                    <tr>
                        ...
                        <td colspan="2" align="right"><select name="costAttribute" id="costAttribute" class="select_box" style="width:220px;background-image:url(images/selectSpl.png);">
                                ...
                                if (isset($_SESSION['qc']['costAttribute'])) {
                                    if ($_SESSION['qc']['costAttribute'] == 'None') {
                                        echo 'selected="selected"';
                                    }
                                }
                                ?>>None</option>
                                <option value="Backcharge" <?php
                                if (isset($_SESSION['qc']['costAttribute'])) {
                                    if ($_SESSION['qc']['costAttribute'] == 'Backcharge') {
                                        echo 'selected="selected"';
                                    }
                                }
                                ?>>Backcharge</option>
                                <option value="Variation" <?php
                                if (isset($_SESSION['qc']['costAttribute'])) {
                                    if ($_SESSION['qc']['costAttribute'] == 'Variation') {
                                        echo 'selected="selected"';
                                    }
                                }
                                ?>>Variation</option>
                    ...
                    <tr>
                        ...
                        <td colspan="2" align="left" nowrap="nowrap" style="color:#FFFFFF;">From 
                            <input name="DRF" type="text" size="7" id="DRF" readonly value="<?php
                            if (isset($_SESSION['qc']['DRF'])) {
                                echo $_SESSION['qc']['DRF'];
                            }
                            ?>" />
                            To 
                            <input name="DRT" type="text" id="DRT" size="7" readonly value="<?php
                            if (isset($_SESSION['qc']['DRT'])) {
                                echo $_SESSION['qc']['DRT'];
                            }
                            ?>" />
                        ...
                        <td colspan="2" align="left" nowrap="nowrap" style="color:#FFFFFF;">From 
                            <input name="FBDF" type="text" id="FBDF" size="7" readonly value="<?php
                            if (isset($_SESSION['qc']['FBDF'])) {
                                echo $_SESSION['qc']['FBDF'];
                            }
                            ?>" />
                            To
                            <input name="FBDT" type="text" id="FBDT" size="7" readonly value="<?php
                            if (isset($_SESSION['qc']['FBDT'])) {
                                echo $_SESSION['qc']['FBDT'];
                            }
                            ?>" />
        ...
        <div>
            <div class="demo_jui" id="show_defect" <?php
            if (isset($_SESSION['ww_is_builder']) && $_SESSION['ww_is_builder'] == 0) {
                echo 'style="padding-left:10px;"';
            }
            ?>></div>
            <div class="spacer"></div>

        </div><div id="spinner"></div>  
        <div id="setSession"></div><div id="listDropVal"></div><div id="userRole"></div>
                    ...
                    if (jsonResult.status) {
                        ...
                        if (typeof oTable == 'undefined') {
                            oTable = $("#inspTable").dataTable({
                                ...
                                "aoColumnDefs": [{"bSearchable": false, "bSortable": false, "aTargets": [2, 8]}],
