...
$mulIssueTo = '';	
	...
	if($report_type == "pdfSummayWithImages"){$pageBreak = 15; $limit = ($pageBreak*10);}else{$pageBreak = 19; $limit = ($pageBreak*10);}
			...
			if($offset == 0){
				...
				if(!empty($_REQUEST['location']) && empty($_REQUEST['subLocation'])){
					$html .= '<td width="170" style="font-size:11px;"><b>Location&nbsp;Name: </b></td>
						<td width="200" style="font-size:11px;">'.$obj->getDataByKey('project_locations', 'location_id', $_REQUEST['location'], 'location_title').'</td>';$jk++; if($jk%2 ==0){$html .= '</tr><tr>';}
				}
				if(!empty($_REQUEST['subLocation']) && !empty($_REQUEST['sub_subLocation'])){
					$html .= '<td width="170" style="font-size:11px;"><b>Location&nbsp;Name: </b></td>
					<td width="200" style="font-size:11px;">'.$obj->getDataByKey('project_locations', 'location_id', $_REQUEST['location'], 'location_title').'</td>';$jk++; if($jk%2 ==0){$html .= '</tr><tr>';}
					$html .= '<td width="170" style="font-size:11px;"><b>Sub&nbsp;Location: </b></td>
					<td width="200" style="font-size:11px;">'.$obj->getDataByKey('project_locations', 'location_id', $_REQUEST['subLocation'], 'location_title').'</td>';$jk++; if($jk%2 ==0){$html .= '</tr><tr>';}
					$html .= '<td width="170" style="font-size:11px;"><b>Sub&nbsp;Location&nbsp;1: </b></td>
					<td width="200" style="font-size:11px;">'.$obj->getDataByKey('project_locations', 'location_id', $_REQUEST['sub_subLocation'], 'location_title').'</td>';$jk++; if($jk%2 ==0){$html .= '</tr><tr>';}
				}else{
					if(!empty($_REQUEST['location']) && !empty($_REQUEST['subLocation'])){
						$html .= '<td width="170" style="font-size:11px;"><b>Location&nbsp;Name: </b></td>
						<td width="200" style="font-size:11px;">'.$obj->getDataByKey('project_locations', 'location_id', $_REQUEST['location'], 'location_title').'</td>';$jk++; if($jk%2 ==0){$html .= '</tr><tr>';}
				...
				if ($oldIssueToName != $fi["IssueToName"] && $oldIssueToName != ''){
					...
					<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							if(!empty($_REQUEST['location']) && empty($_REQUEST['subLocation'])){
								$html .= '<td width="170" style="font-size:11px;"><b>Location&nbsp;Name: </b></td>
									<td width="200" style="font-size:11px;">'.$obj->getDataByKey('project_locations', 'location_id', $_REQUEST['location'], 'location_title').'</td>';$jk++;
							}
							if(!empty($_REQUEST['subLocation']) && !empty($_REQUEST['sub_subLocation'])){
								$html .= '<td width="170" style="font-size:11px;"><b>Location&nbsp;Name: </b></td>
								<td width="200" style="font-size:11px;">'.$obj->getDataByKey('project_locations', 'location_id', $_REQUEST['location'], 'location_title').'</td>';$jk++;
