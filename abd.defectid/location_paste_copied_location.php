...
if(isset($_REQUEST['uniqueId'])){
	...
	function pasteLocations($cat, $pId){
		...
		if(mysql_num_rows($title_res) > 0){
			...
			$insert_query = "INSERT INTO project_locations SET project_id = '".$_SESSION['idp']."', location_title = '".$title." (Copy ".$_SESSION['pasteCount'].")', location_parent_id = '".$pId."', created_date = now(), created_by = '".$_SESSION['ww_builder_id']."', last_modified_date = NOW(), last_modified_by = '".$_SESSION['ww_builder_id']."'";
