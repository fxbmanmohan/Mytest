...
$html='<table width="98%" border="0" align="center">
			...
			<tr>
				...
				$jk=0;
				if(!empty($_REQUEST['location']) && empty($_REQUEST['subLocation'])){
					$html .= '<td width="120" style="font-size:11px;"><b>Location Name : </b></td>
...
/*				if(!empty($_REQUEST['status']) && isset($_REQUEST['status'])){
				...
				$html .='<table width="98%" class="collapse" cellpadding="0" cellspaccing="0" align="center" border="0">
					<tr>
						...
						<td width="10%" align="center" style="background-color:#CCCCCC;"><i>Certificate of occupancy</i></td>
						<td width="10%" align="center" style="background-color:#CCCCCC;"><i>Proposed completion</i></td>
						<td width="10%" align="center" style="background-color:#CCCCCC;"><i>Actual completion</i></td>
...
/*					foreach($proInsData as $piData){
				...
				//	print_r($proInsData);
					...
					foreach($htmlDataArr as $htmlData){
						$html .='<tr>
							<td>'.$htmlData['issuedName'].'</td>
							<td>'.$certificate_of_occupancy.'&nbsp;</td>
							<td>'.$proposed_completion.'&nbsp;</td>
							<td>'.$actual_completion.'&nbsp;</td>			
							<td align="center">'.$htmlData['noOfInsp'].'</td>
							<td align="center">'.$htmlData['open'].'</td>';
							$html .='<td align="center">'.$htmlData['closed'].'</td>';
							$html .='<td align="center">'.$htmlData['pending'].'</td>';
						$html .='<tr>';
					}						
