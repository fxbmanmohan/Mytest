...
$location_query = "SELECT location_id, location_title FROM project_locations WHERE project_id = ".$_SESSION['idp']." AND location_parent_id = '".$_POST['cetid']."' AND is_deleted = '0' ORDER BY location_title";
if($_POST['cetid'] == 0){
	$class = 'telefilms';
}else{
	$class = '';
