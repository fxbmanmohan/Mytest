...
if($_POST['task'] == 'checkListForm'){
	...
	if($checkListStatus){
		$updateIssueto = "UPDATE issued_to_for_inspections SET inspection_status = 'Draft' WHERE inspection_id = '".$_POST['inspectionId']."' AND project_id = '".$_POST['projectId']."'";
		...
		$updateIssueto = "UPDATE issued_to_for_inspections SET inspection_status = 'Open' WHERE inspection_id = '".$_POST['inspectionId']."' AND project_id = '".$_POST['projectId']."'";
		mysql_query($updateIssueto);
